...
import { ar_legocontroller, ar_medflow, ar_oledDemo, gd_atlasm1, gd_flockofcats, sw_pybot, sw_website, sw_xinu, ui_cardinal, ui_cordiall, ui_websiteredesign} from "../../components/projects/DetailedProjects";
function Projects() {
  return (
    <div>
